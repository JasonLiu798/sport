...
<div class="">
    ...
    <div class="pcomment_left">
        <div class="pcomment_meta">
            <ul class="pcomment_meta_ul">
                ...
                <li><span class="comment_username">来自：<a href="<?php echo U('user/detail');?>/<?php echo ($pcomment['uid']); ?>"><?php echo ($pcomment['username']); ?></a></span></li>
            </ul>
        </div>
    ...
    <div class="col-md-offset-1 child_comments">
        <?php if(is_array($comments)): foreach($comments as $key=>$comment): ?><div class="child_comment">
                <div class="col-md--1 child_comment_head">
                    <img src="<?php echo U('public/image'); echo ($comment['head_iminurl']); ?>"/>
                </div>
                <div class="child_comment_detail">
                    <div class="child_comment_meta">
                        <ul>
                            <li><?php echo date('Y-m-d H:i:s',strtotime($comment['create_time'])) ;?></li>
                            <li> <a href="<?php echo U('user/detail');?>/<?php echo ($comment['uid']); ?>"><?php echo ($comment['username']); ?></a></li>
                        </ul>
                    </div>
                    <div class="clearfix"></div>
